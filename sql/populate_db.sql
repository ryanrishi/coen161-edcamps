INSERT INTO activities (name, description, image_url) VALUES ("Pottery", "Make your own customized bowls and plates out of clay.", "pottery.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("3D Printing", "Make a three-dimensional object of your choice.", "3dprint.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Swimming", "Swim at nearby lakes and waterparks and engage in a variety of water sports.", "swim.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Soccer", "Play for fun or join our soccer tournament for a chance to win prizes.", "soccer.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Programming", "Learn the foundations of basic coding languages.", "program.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Robotics", "Utilize Lego Mindstorm kits and Robolab software to design your very own robot.", "robotics.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Tennis", "Tennis lessons available for all levels.","tennis.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Kayaking", "Join us as we explore the waters and fish in kayaks.", "kayak.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Basketball", "Join a team for our basketball tournament.", "basketball.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Pre-programming", "Learn math programming foundations and problem solving strategies before diving into more complex coding.", "preprogram.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Rock climbing", "Begin in the rock climbing gym and by the end of camp try rock climbing in the outdoors.", "rockclimb.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Hiking", "One, two and four hour hikes are available to the top of various nearby peaks.", "hike.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Baseball", "Improve your batting and fielding skills as you learn from our experts.", "baseball.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Biking", "Bike along mountain, beach, and street trails.", "bike.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Zoo", "Spend the day enjoying the nearby zoo. Private tours avaiable at select locations.", "zoo.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Horseback riding", "Join us as we ride horses through forest trails.", "horse.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Disc golf", "See if you can traverse the disc golf course from beginning to end in the fewest number of disk throws.", "discgolf.jpg");
INSERT INTO activities (name, description, image_url) VALUES ("Drawing", "Drawing and painting lessons available for students of all levels.", "draw.jpg");
...
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Timmy", "Gonzalez", "2007-05-24", 4, 1);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Jason", "Romero", "2006-03-04", 5, 2);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Lily", "Romero", "2008-12-06", 3, 2);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Sophie", "Stone", "2007-10-12", 4, 3);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Mark", "Eaton", "2009-08-15", 2, 4);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Jennifer", "Eaton","2010-11-22", 1, 4);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Melissa", "Michael", "2005-03-12", 1, 5);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Cameron", "Iverson", "2009-07-04", 2, 6);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("George", "Harrison", "2007-10-31", 4, 7);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Carly", "Greene", "2005-02-14", 1, 8);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Mariah", "Lopez", "2008-05-17", 3, 9);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Jenna", "Lawrence", "2007-10-25", 4, 10);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Peter", "Owens", "2010-12-04", 1, 11);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Jane", "Heffernen", "2006-07-26", 5, 12);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Eliza", "Jackson", "2009-08-14", 2, 13);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Caitlin", "Martinez", "2009-02-17", 2, 14);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Michael", "Blake", "2007-06-20", 4,15);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("James", "Morrison", "2005-02-27", 1, 16);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Charlotte", "Mcdermott", "2006-08-14", 5, 17);
INSERT INTO campers (first_name, last_name, dob, grade, parent1_id) VALUES ("Patrick", "Mcdermott", "2008-10-30", 3, 17);

INSERT INTO registrations (camper_id, session_id) VALUES (1, 1);
INSERT INTO registrations (camper_id, session_id) VALUES (2, 2);
...
INSERT INTO registrations (camper_id, session_id) VALUES (10, 8);
INSERT INTO registrations (camper_id, session_id) VALUES (11, 8);
INSERT INTO registrations (camper_id, session_id) VALUES (12, 3);
INSERT INTO registrations (camper_id, session_id) VALUES (13, 2);
INSERT INTO registrations (camper_id, session_id) VALUES (14, 2);
INSERT INTO registrations (camper_id, session_id) VALUES (15, 1);
INSERT INTO registrations (camper_id, session_id) VALUES (16, 5);
INSERT INTO registrations (camper_id, session_id) VALUES (17, 5);
INSERT INTO registrations (camper_id, session_id) VALUES (18, 1);
INSERT INTO registrations (camper_id, session_id) VALUES (19, 6);
INSERT INTO registrations (camper_id, session_id) VALUES (20, 6);
